...
export const strings = {
  ...
  settings: {
    ...
    data: {
      title: 'Meus dados',
      desc: 'Seus dados ficam seguros sem você precisar fazer nada. Estes botões são pra quando você quiser levá-los embora ou trazê-los de volta.',
      rowTitle: 'Baixar meus dados',
      rowDesc: 'Um JSON com checks, eventos, pets, configurações — o documento inteiro, sem e-mail nem identificador. Serve pra você ter uma cópia sua, e pra levar pra outro lugar.',
      button: 'Baixar (JSON)',
      done: 'Arquivo gerado ✓',
      failed: 'Não deu pra gerar o arquivo neste navegador.',
      restoreTitle: 'Restaurar de um arquivo',
      restoreDesc: 'Um JSON baixado daqui volta a ser o seu plano. Substitui o que estiver na conta agora.',
      restoreButton: 'Escolher arquivo',
      restoreDone: 'Dados restaurados ✓',
      restoreErrors: {
        'nao-e-json': 'Esse arquivo não é um JSON válido.',
        'nao-e-do-study-pets': 'Esse arquivo não parece ser um backup do Study Pets.',
        'vazio': 'O arquivo está vazio.',
        'sem-arquivo': 'Não deu pra ler o arquivo neste navegador.',
        'sem-usuario': 'Entre na sua conta antes de restaurar.',
        'sem-rede': 'Não há nada pra desfazer.',
        'vencida': 'O prazo de 30 dias para desfazer já passou.',
      },
      netTitle: 'Histórico apagado — dá pra voltar atrás',
      netDesc: (dia: string, dias: number) =>
        `Você apagou tudo em ${dia}. A cópia fica guardada e some sozinha ${dias === 0 ? 'hoje' : dias === 1 ? 'amanhã' : `em ${dias} dias`}.`,
      netRestore: 'Restaurar',
      netDiscard: 'Descartar',
      netDiscarded: 'Cópia descartada.',
    },
    avatar: {
    ...
    cancel: {
      ...
      outro: 'Depois você começa do zero, como uma conta nova — mas o app guarda uma cópia por 30 dias. ',
      outroStrong: 'Dá pra voltar atrás em Configurações → Meus dados.',
      back: 'Voltar',
