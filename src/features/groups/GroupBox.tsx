...
// dela, as linhas membros. Tocar no cabeçalho abre a edição. Cor própria (`--gc`),
// fora da paleta das sessões — grupo é outra camada, não outra sessão.
...
export function GroupBox({ group, progress: p, empty = false, onEdit, children }: Props) {
  ...
  return (
    <div className={'group-box' + (complete ? ' complete' : '') + (empty ? ' empty' : '')}>
