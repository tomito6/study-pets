...
test.describe('Study Pets — smoke', () => {
  ...
  test('15. o pet ganha nome ao adotar, XP ao fechar o dia, e evolui escolhendo o caminho', async ({ page }) => {
    ...
    await expect(page.locator('#my-pets-evo')).toHaveText('1 pode evoluir');
    ...
    await expect(page.locator('#ap-evo-badge')).toHaveCount(0); // evoluiu: o selo some sozinho
    await expect(page.locator('#my-pets-evo')).toHaveCount(0);
